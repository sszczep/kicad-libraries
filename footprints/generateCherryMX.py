...
variantsList = [
  ...
  ("Plate_Stab", ["BaseStart", "Pins", "Stab", "BaseEnd"]),
  ("Plate_LED", ["BaseStart", "Pins", "LED", "BaseEnd"]),
  ("Plate_Stab_LED", ["BaseStart", "Pins", "Stab", "LED", "BaseEnd"]),
  ...
  ("Plate_Stab_LTST-A683CEGBW", ["BaseStart", "Pins", "Stab", "LTST-A683CEGBW", "BaseEnd"]),
  ("Plate_Stab_LTST-A683CEGBW-Rotated", ["BaseStart", "Pins", "Stab", "LTST-A683CEGBW-Rotated", "BaseEnd"]),
  ("Plate_KailhSocket", ["BaseStart", "KailhSocket", "BaseEnd"]),
  ("Plate_KailhSocket_Stab", ["BaseStart", "KailhSocket", "Stab", "BaseEnd"]),
  ("Plate_KailhSocket_LED", ["BaseStart", "KailhSocket", "LED", "BaseEnd"]),
  ("Plate_KailhSocket_Stab_LED", ["BaseStart", "KailhSocket", "Stab", "LED", "BaseEnd"]),
  ...
  ("Plate_KailhSocket_Stab_LTST-A683CEGBW", ["BaseStart", "KailhSocket", "Stab", "LTST-A683CEGBW", "BaseEnd"]),
  ("Plate_KailhSocket_Stab_LTST-A683CEGBW-Rotated", ["BaseStart", "KailhSocket", "Stab", "LTST-A683CEGBW-Rotated", "BaseEnd"]),
  ("PCB", ["BaseStart", "Pins", "PCB", "BaseEnd"]),
  ("PCB_Stab", ["BaseStart", "Pins", "PCB", "Stab", "BaseEnd"]),
  ("PCB_LED", ["BaseStart", "Pins", "PCB", "LED", "BaseEnd"]),
  ("PCB_Stab_LED", ["BaseStart", "Pins", "PCB", "Stab", "LED", "BaseEnd"]),
  ...
  ("PCB_Stab_LTST-A683CEGBW", ["BaseStart", "Pins", "PCB", "Stab", "LTST-A683CEGBW", "BaseEnd"]),
  ("PCB_Stab_LTST-A683CEGBW-Rotated", ["BaseStart", "Pins", "PCB", "Stab", "LTST-A683CEGBW-Rotated", "BaseEnd"]),
  ("PCB_KailhSocket", ["BaseStart", "KailhSocket", "PCB", "BaseEnd"]),
  ("PCB_KailhSocket_Stab", ["BaseStart", "KailhSocket", "PCB", "Stab", "BaseEnd"]),
  ("PCB_KailhSocket_LED", ["BaseStart", "KailhSocket", "PCB", "LED", "BaseEnd"]),
  ("PCB_KailhSocket_Stab_LED", ["BaseStart", "KailhSocket", "PCB", "Stab", "LED", "BaseEnd"]),
  ...
  ("PCB_KailhSocket_Stab_LTST-A683CEGBW", ["BaseStart", "KailhSocket", "PCB", "Stab", "LTST-A683CEGBW", "BaseEnd"]),
  ("PCB_KailhSocket_Stab_LTST-A683CEGBW-Rotated", ["BaseStart", "KailhSocket", "PCB", "Stab", "LTST-A683CEGBW-Rotated", "BaseEnd"]),
]
